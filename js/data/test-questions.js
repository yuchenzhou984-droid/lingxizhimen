const TEST1_QUESTIONS = [
  {
    ...
    options: [
      { text: '点火把，大步深入。', scores: { fire: 2, wind: 1 } },
      { text: '闭眼倾听，让直觉带路。', scores: { water: 2, darkmoon: 1 } },
      { text: '手掌贴着古树，让森林告诉你答案。', scores: { earth: 2, water: 1 } },
      { text: '送出温润的光，先让脚下安全。', scores: { lightheal: 2, earth: 1 } }
    ]
  },
  {
    id: 2,
